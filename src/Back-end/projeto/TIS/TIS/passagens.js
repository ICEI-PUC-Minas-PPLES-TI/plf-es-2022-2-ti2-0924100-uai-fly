...
const preencheDadosDaspassagems = (passagemItem, item, index) => {
    ...
    passagemItem.querySelector('.passagemInfo--chegada').innerHTML = item.chegada
    passagemItem.querySelector('.passagemInfo--num').innerHTML = item.numero_voo
    passagemItem.querySelector('.passagemInfo--comp').innerHTML = item.companhia
}

const preencheDadosModal = (item) => {
    seleciona('.passagemBig img').src = item.img
    seleciona('.passagemInfo h1').innerHTML = item.name
    seleciona('.passagemInfo--chegada').innerHTML = item.chegada
    seleciona('.passagemInfo--num').innerHTML = item.numero_voo
    seleciona('.passagemInfo--comp').innerHTML = item.companhia
