...
![image](https://user-images.githubusercontent.com/111388245/203650953-3c78dea3-3a01-4269-88d2-5cd3ec4a3d88.png)
...
| Valor Medio de passagens | Controle financeiro sobre o faturamento de cada venda	 | Retorna o valor do ticket medio | Faturamento ÷ Venda  | Tabela Compra | Processo interno |

| Número de avaliações negativas(semanais) | Controlar e avaliar os feedbeck dos clientes | Retorna o numero de avaliacoes negativas por semana | (Numero De avaliações negativas + Numero De Cientes ) /7  | Tabela avaliações | Analisar qualidade de serviço |
