...
Em nossa aplicação temos as seguintes entidades envolvidas: as empresa de aviação, nas quais ofertam os melhores pacotes possíveis, e os usuários, que utilizam o aplicativo para a compra de passagens. 
